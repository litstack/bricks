<div class="fixed top-0 left-0 z-50 w-full h-full transition-all duration-500 origin-center scale-95 bg-white opacity-0 pointer-events-none lit-scroll-gallery" id="{{ $id }}">
